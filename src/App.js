  ...
  render() {
    return (
      <div className="App">
        ...
        <Route path={'/group/:id'} render={({match}) => <ActionCableProvider url={`ws://brewforyouapi.heroku.com/cable?token=${localStorage.getItem('jwt')}`}><Group id={match.params.id} /></ActionCableProvider>}/>
